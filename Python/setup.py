...
setup_args = dict(name='controller',
package_dir={ '' : package_dir },
      version='1.0.0', # @VERSION_INFO@
      description='Simulate controller with real-life examples',
      url='https://github.com/ludvikalkhoury/PID-Controller-Simulation.git',
...
if __name__ == '__main__' and getattr( sys, 'argv', [] )[ 1: ]:
	...
	sys.stderr.write( """
The `controller` setup.py file should not be run or imported directly.
